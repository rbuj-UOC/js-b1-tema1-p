...
import { tests } from '../U5/U5EJ2.js';
describe('tests', () => {
  const planetDiameter = tests()[0];
  const result = tests()[1];
  test('checks if planetDiameter function is an Arrow Function', () => {
    expect(planetDiameter.toString().indexOf('=>')).toBeGreaterThan(0);
  });
